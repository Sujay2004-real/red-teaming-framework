...
class Reporter:
    ...
    def generate_html_report(self, target, objective, findings, executions, output_path, engagement_brief=None):
        ...
        html = template.render(target=target, objective=objective, findings=findings, executions=executions, total_findings=len(findings), severity_counts=severity_counts, engagement=engagement)
